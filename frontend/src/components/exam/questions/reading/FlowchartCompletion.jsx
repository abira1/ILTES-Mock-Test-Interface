...
const FlowchartCompletion = ({ question, answer, onAnswerChange }) => {
  const { flowchart, steps, passage, context, orientation, options } = question.payload || {};
  ...
  return (
    <div className="flowchart-completion-reading-question">
      {passage && (
